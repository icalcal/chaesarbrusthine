        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} Uwahh  ${nama} semangat sekali wkwk`).then(function () {
                Swal.fire({
                  title: 'Seberapa sayang dengan kesehatan?',
                  icon: 'question',
                  input: 'range',
                  ...
                  Swal.fire(`Tetap jaga kesehatan kamu yaa ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${nama} harus semangat yaa dan jaga kesehatan :) ${sender}`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Uwahh kamu keren ${sender}   ${nama} , makasihhh yaa`).then(function () {
                          Swal.fire('Terakhir deh ').then(function () {
                            Swal.fire('Coba klik kata pengirim :D')
                          })
                        })
